...
import { listSedesWithStockForFeed } from "@/lib/stockDb";
 ...
 *
 * @response 200 - @en `{ updatedAt, count, items, centros: { count, items: FeedCentro[] } }` | @es `{ updatedAt, count, items, centros: { count, items: FeedCentro[] } }`
